    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="absolute top-4 left-4 text-white">
        <div className="bg-black/50 backdrop-blur-sm rounded-lg p-3 border border-cyan-400/30">
          ...
          <div className="text-xl font-bold text-cyan-400">Level 85</div>
          <div className="text-xs text-green-400">Software Engineer</div>
        </div>
      </div>
        ...
        <div className="bg-black/50 backdrop-blur-sm rounded-lg p-3 border border-cyan-400/30">
          <div className="mb-2">
            ...
            <div className="w-24 h-2 bg-gray-700 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-red-500 to-red-400 w-4/5"></div>
            </div>
          </div>
          <div>
            <div className="flex items-center gap-2 mb-1">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center">
            ...
            <div className="relative w-32 h-32 mx-auto mb-6">
              <div className="w-full h-full rounded-full bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-600 p-1 animate-spin-slow">
                <div className="w-full h-full rounded-full bg-slate-900 flex items-center justify-center">
                  <Gamepad2 className="text-4xl text-cyan-400" size={48} />
                </div>
              </div>
              {/* Level indicator */}
              <div className="absolute -top-2 -right-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-black text-xs font-bold px-2 py-1 rounded-full border-2 border-white">
                85
              </div>
              {/* Achievement badges */}
              <div className="absolute -bottom-2 -left-2 bg-gradient-to-r from-green-400 to-emerald-500 p-1 rounded-full">
          ...
          <div className="flex justify-center items-center gap-3 mb-6">
            <div className="bg-gradient-to-r from-purple-500/20 to-cyan-500/20 backdrop-blur-sm border border-purple-400/30 rounded-full px-4 py-2">
              <span className="text-purple-300 font-semibold">🎮 Software Engineer</span>
            </div>
            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm border border-green-400/30 rounded-full px-3 py-2">
